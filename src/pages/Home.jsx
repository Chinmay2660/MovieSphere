...
const Home = () => {
  ...
  const popularMoviesData = useSelector((state) => state.movieData.popularMoviesData);
    ...
    const fetchData = async () => {
      try {
        ...
        if (!popularMoviesData.length) {
          requests.push(axiosInstance.get('/movie/popular'));
          handlers.push((data) => dispatch(setPopularMoviesData(data.results)));
        }
